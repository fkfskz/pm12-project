...
1. Оформление отчета. Подготовка к защите.
...
2. Завершить задания по теме Web-дизайн:
   <p>закончить оформление титульной страницы;</p>
   <p>выполнить практические задания 30-35.</p>
...
1. Выполнить упражнения и примеры по VBA, Visual Basic for Application:
   <p>упражнение 3 Практические работы с применением макросов;</p>
   <p>упражнение 4 Пользовательские формы.</p>
